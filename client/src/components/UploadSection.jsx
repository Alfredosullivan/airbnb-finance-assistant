    ...
    <section className="upload-section">
      ...
      <div className="upload-grid">
        ...
        >
          ...
          {statuses.airbnb && <div className="upload-card__status">{statuses.airbnb}</div>}
          <input
            ref={airbnbRef}
            type="file"
            accept=".csv,.pdf"
        ...
        <div className="bank-column">
          ...
          >
            ...
            <p className="upload-card__hint">Haz clic para seleccionar</p>
            {statuses.bank1 && <div className="upload-card__status">{statuses.bank1}</div>}
            <input
              ref={bank1Ref}
              type="file"
              accept=".pdf"
          ...
          >
            ...
            {statuses.bank2 && <div className="upload-card__status">{statuses.bank2}</div>}
            <input
              ref={bank2Ref}
              type="file"
              accept=".pdf"
